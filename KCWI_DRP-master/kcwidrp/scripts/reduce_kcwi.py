...
def main():
    ...
    if args.line_thresh:
        ...
        if args.lowres:
            framework.config.instrument.LINETHRESH = float(
                kcwi_config.LOWRES['linethresh'])
        elif args.medres:
            framework.config.instrument.LINETHRESH = float(
                kcwi_config.MEDRES['linethresh'])
    ...
    if args.tukey_alpha:
        ...
        if args.lowres:
            framework.config.instrument.TUKEYALPHA = float(
                kcwi_config.LOWRES['tukeyalpha'])
        elif args.medres:
            framework.config.instrument.TUKEYALPHA = float(
                kcwi_config.MEDRES['tukeyalpha'])
    ...
    if args.max_frac:
        ...
        if args.lowres:
            framework.config.instrument.FRACMAX = float(
                kcwi_config.LOWRES['fracmax'])
        elif args.medres:
            framework.config.instrument.FRACMAX = float(
                kcwi_config.MEDRES['fracmax'])
    ...
    if args.proctab:
        ...
        if args.lowres:
            proctab = kcwi_config.LOWRES['procfile']
        elif args.medres:
            proctab = kcwi_config.MEDRES['procfile']
        else:
    ...
    if args.lowres:
        framework.config.instrument.arc_min_nframes = int(
            kcwi_config.LOWRES['arc_min_nframes'])
        framework.config.instrument.contbars_min_nframes = int(
            kcwi_config.LOWRES['contbars_min_nframes'])
        framework.config.instrument.object_min_nframes = int(
            kcwi_config.LOWRES['object_min_nframes'])
        framework.config.instrument.minoscanpix = int(
            kcwi_config.LOWRES['minoscanpix'])
        framework.config.instrument.oscanbuf = int(
            kcwi_config.LOWRES['oscanbuf'])
    elif args.medres:
        framework.config.instrument.arc_min_nframes = int(
            kcwi_config.MEDRES['arc_min_nframes'])
        framework.config.instrument.contbars_min_nframes = int(
            kcwi_config.MEDRES['contbars_min_nframes'])
        framework.config.instrument.object_min_nframes = int(
            kcwi_config.MEDRES['object_min_nframes'])
        framework.config.instrument.minoscanpix = int(
            kcwi_config.MEDRES['minoscanpix'])
        framework.config.instrument.oscanbuf = int(
            kcwi_config.MEDRES['oscanbuf'])
